...
Berkay Gemici developed the Cartoony app as a Freemium app. This SERVICE is provided by Berkay Gemici at no cost and is intended for use as is.
...
The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at Cartoony unless otherwise defined in this Privacy Policy.
...
Cartoony allows users to upload photos, which may contain faces. However, the app does not collect, analyze, or extract any facial features or biometric data. The uploaded images are used solely for generating cartoon-style transformations.

#### Purpose of Face Data Usage
The uploaded images are used exclusively to generate cartoon-style images using the Google Gemini API. The app does not perform any additional processing, storage, or analysis of facial data beyond this transformation.

#### Sharing of Face Data
Cartoony does not store or retain any face data. The uploaded images are sent directly to Google’s Gemini API for processing, and the transformed images are returned to the user. No images are shared with any third party other than Google Gemini for processing.

#### Retention of Face Data
The app does not retain any face data. Images are temporarily used for processing and discarded immediately after the transformation is completed.
